...
public abstract class AbstractSpringFeignController {
	private final static Logger LOG = LoggerFactory.getLogger(AbstractSpringFeignController.class);

	public abstract BasicSpringFeignClient client();

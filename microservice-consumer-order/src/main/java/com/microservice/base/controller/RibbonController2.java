...
public class RibbonController2 {
	...
	public String exception(@PathVariable String arg){
		return restTemplate.getForObject("http://microservice-provider-user2/exception/"+arg, String.class);
	}
	/**
	...
	public String overtime(@PathVariable Long second){
		return restTemplate.getForObject("http://microservice-provider-user2/overtime/"+second, String.class);
	}
